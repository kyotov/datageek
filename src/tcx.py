...
#
# Generated Sat Dec 25 17:51:04 2010 by generateDS.py version 2.3a.
#
...
class Device_t(AbstractSource_t):
    ...
    def exportLiteral(self, outfile, level, name_='Device_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(Device_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        ...
        super(Device_t, self).buildChildren(child_, nodeName_, True)
# end class Device_t
...
class Application_t(AbstractSource_t):
    ...
    def exportLiteral(self, outfile, level, name_='Application_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(Application_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Build': 
            ...
            LangID_ = child_.text
            self.LangID = LangID_
            self.validate_LangID(self.LangID)    # validate type LangID
        elif nodeName_ == 'PartNumber':
            PartNumber_ = child_.text
            self.PartNumber = PartNumber_
            self.validate_PartNumber(self.PartNumber)    # validate type PartNumber
        super(Application_t, self).buildChildren(child_, nodeName_, True)
...
class Build_t(GeneratedsSuper):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Version': 
            ...
            Type_ = child_.text
            self.Type = Type_
            self.validate_Type(self.Type)    # validate type Type
        elif nodeName_ == 'Time':
            Time_ = child_.text
            self.Time = Time_
            self.validate_Time(self.Time)    # validate type Time
        elif nodeName_ == 'Builder':
            Builder_ = child_.text
            self.Builder = Builder_
            self.validate_Builder(self.Builder)    # validate type Builder
# end class Build_t
...
class Training_t(GeneratedsSuper):
    ...
    def exportLiteral(self, outfile, level, name_='Training_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        if self.VirtualPartner is not None:
            showIndent(outfile, level)
...
class Plan_t(GeneratedsSuper):
    ...
    def exportLiteralAttributes(self, outfile, level, name_):
        if self.Type is not None:
            showIndent(outfile, level)
            outfile.write('Type = %s,\n' % (self.Type,))
        if self.IntervalWorkout is not None:
            showIndent(outfile, level)
...
class ActivityLap_t(GeneratedsSuper):
    ...
    def validate_TriggerMethod(self, value):
        # validate type TriggerMethod
        pass
    ...
    def exportChildren(self, outfile, level, namespace_='tc2:', name_='ActivityLap_t'):
        ...
        if self.Cadence is not None:
            showIndent(outfile, level)
            outfile.write('<%sCadence>%s</%sCadence>\n' % (namespace_, self.gds_format_string(quote_xml(self.Cadence).encode(ExternalEncoding), input_name='Cadence'), namespace_))
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.Cadence is not None:
            showIndent(outfile, level)
            outfile.write('Cadence=%s,\n' % quote_python(self.Cadence).encode(ExternalEncoding))
        if self.TriggerMethod is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'TotalTimeSeconds':
            ...
            self.validate_Intensity(self.Intensity)    # validate type Intensity
        elif nodeName_ == 'Cadence':
            Cadence_ = child_.text
            self.Cadence = Cadence_
            self.validate_Cadence(self.Cadence)    # validate type Cadence
        elif nodeName_ == 'TriggerMethod':
            TriggerMethod_ = child_.text
            self.TriggerMethod = TriggerMethod_
            self.validate_TriggerMethod(self.TriggerMethod)    # validate type TriggerMethod
...
class Trackpoint_t(GeneratedsSuper):
    ...
    def validate_SensorState(self, value):
        # validate type SensorState
        pass
    def get_Extensions(self): return self.Extensions
    def set_Extensions(self, Extensions): self.Extensions = Extensions
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Time':
            ...
            self.validate_SensorState(self.SensorState)    # validate type SensorState
        elif nodeName_ == 'Extensions': 
            obj_ = Extensions_t.factory()
            obj_.build(child_)
            self.set_Extensions(obj_)
...
class Position_t(GeneratedsSuper):
    ...
    def validate_LatitudeDegrees(self, value):
        # validate type LatitudeDegrees
        pass
    ...
    def validate_LongitudeDegrees(self, value):
        # validate type LongitudeDegrees
        pass
    ...
    def exportChildren(self, outfile, level, namespace_='tc2:', name_='Position_t'):
        if self.LatitudeDegrees is not None:
            showIndent(outfile, level)
            outfile.write('<%sLatitudeDegrees>%s</%sLatitudeDegrees>\n' % (namespace_, self.gds_format_string(quote_xml(self.LatitudeDegrees).encode(ExternalEncoding), input_name='LatitudeDegrees'), namespace_))
        if self.LongitudeDegrees is not None:
            showIndent(outfile, level)
            outfile.write('<%sLongitudeDegrees>%s</%sLongitudeDegrees>\n' % (namespace_, self.gds_format_string(quote_xml(self.LongitudeDegrees).encode(ExternalEncoding), input_name='LongitudeDegrees'), namespace_))
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.LatitudeDegrees is not None:
            showIndent(outfile, level)
            outfile.write('LatitudeDegrees=%s,\n' % quote_python(self.LatitudeDegrees).encode(ExternalEncoding))
        if self.LongitudeDegrees is not None:
            showIndent(outfile, level)
            outfile.write('LongitudeDegrees=%s,\n' % quote_python(self.LongitudeDegrees).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'LatitudeDegrees':
            LatitudeDegrees_ = child_.text
            self.LatitudeDegrees = LatitudeDegrees_
            self.validate_LatitudeDegrees(self.LatitudeDegrees)    # validate type LatitudeDegrees
        elif nodeName_ == 'LongitudeDegrees':
            LongitudeDegrees_ = child_.text
            self.LongitudeDegrees = LongitudeDegrees_
            self.validate_LongitudeDegrees(self.LongitudeDegrees)    # validate type LongitudeDegrees
...
class AbstractStep_t(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='tc2:', name_='AbstractStep_t'):
        if self.StepId is not None:
            showIndent(outfile, level)
            outfile.write('<%sStepId>%s</%sStepId>\n' % (namespace_, self.gds_format_string(quote_xml(self.StepId).encode(ExternalEncoding), input_name='StepId'), namespace_))
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.StepId is not None:
            showIndent(outfile, level)
            outfile.write('StepId=%s,\n' % quote_python(self.StepId).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'StepId':
            StepId_ = child_.text
            self.StepId = StepId_
            self.validate_StepId(self.StepId)    # validate type StepId
...
class Repeat_t(AbstractStep_t):
    ...
    def exportChildren(self, outfile, level, namespace_='tc2:', name_='Repeat_t'):
        ...
        if self.Repetitions is not None:
            showIndent(outfile, level)
            outfile.write('<%sRepetitions>%s</%sRepetitions>\n' % (namespace_, self.gds_format_string(quote_xml(self.Repetitions).encode(ExternalEncoding), input_name='Repetitions'), namespace_))
    ...
    def exportLiteral(self, outfile, level, name_='Repeat_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(Repeat_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(Repeat_t, self).exportLiteralChildren(outfile, level, name_)
        if self.Repetitions is not None:
            showIndent(outfile, level)
            outfile.write('Repetitions=%s,\n' % quote_python(self.Repetitions).encode(ExternalEncoding))
        showIndent(outfile, level)
        outfile.write('Child=[\n')
        level += 1
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Repetitions':
            Repetitions_ = child_.text
            self.Repetitions = Repetitions_
            self.validate_Repetitions(self.Repetitions)    # validate type Repetitions
        ...
        super(Repeat_t, self).buildChildren(child_, nodeName_, True)
# end class Repeat_t
...
class Step_t(AbstractStep_t):
    ...
    def exportLiteral(self, outfile, level, name_='Step_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(Step_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        ...
        super(Step_t, self).buildChildren(child_, nodeName_, True)
# end class Step_t
...
class Time_t(Duration_t):
    ...
    def exportLiteral(self, outfile, level, name_='Time_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(Time_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        ...
        super(Time_t, self).buildChildren(child_, nodeName_, True)
# end class Time_t
...
class Distance_t(Duration_t):
    ...
    def exportLiteral(self, outfile, level, name_='Distance_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(Distance_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Meters':
            Meters_ = child_.text
            self.Meters = Meters_
        super(Distance_t, self).buildChildren(child_, nodeName_, True)
...
class HeartRateAbove_t(Duration_t):
    ...
    def exportChildren(self, outfile, level, namespace_='tc2:', name_='HeartRateAbove_t'):
        ...
        self.HeartRate.export(outfile, level, namespace_, name_='HeartRate')
    def hasContent_(self):
        if (
    ...
    def exportLiteral(self, outfile, level, name_='HeartRateAbove_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(HeartRateAbove_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        ...
        super(HeartRateAbove_t, self).buildChildren(child_, nodeName_, True)
...
class HeartRateBelow_t(Duration_t):
    ...
    def exportLiteral(self, outfile, level, name_='HeartRateBelow_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(HeartRateBelow_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if nodeName_ == 'HeartRate': 
            ...
            if type_name_ is not None:
                ...
                raise NotImplementedError(
                    'Class not implemented for <HeartRate> element')
            self.set_HeartRate(obj_)
        super(HeartRateBelow_t, self).buildChildren(child_, nodeName_, True)
...
class CaloriesBurned_t(Duration_t):
    ...
    def exportLiteral(self, outfile, level, name_='CaloriesBurned_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(CaloriesBurned_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Calories':
            Calories_ = child_.text
            self.Calories = Calories_
        super(CaloriesBurned_t, self).buildChildren(child_, nodeName_, True)
...
class UserInitiated_t(Duration_t):
    ...
    def exportLiteral(self, outfile, level, name_='UserInitiated_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(UserInitiated_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        super(UserInitiated_t, self).buildChildren(child_, nodeName_, True)
        pass
...
class Speed_t(Target_t):
    ...
    def exportChildren(self, outfile, level, namespace_='tc2:', name_='Speed_t'):
        ...
        self.SpeedZone.export(outfile, level, namespace_, name_='SpeedZone')
    def hasContent_(self):
        if (
    ...
    def exportLiteral(self, outfile, level, name_='Speed_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(Speed_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        ...
        super(Speed_t, self).buildChildren(child_, nodeName_, True)
# end class Speed_t
...
class HeartRate_t(Target_t):
    ...
    def exportChildren(self, outfile, level, namespace_='tc2:', name_='HeartRate_t'):
        ...
        self.HeartRateZone.export(outfile, level, namespace_, name_='HeartRateZone')
    def hasContent_(self):
        if (
    ...
    def exportLiteral(self, outfile, level, name_='HeartRate_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(HeartRate_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        ...
        super(HeartRate_t, self).buildChildren(child_, nodeName_, True)
...
class Cadence_t(Target_t):
    ...
    def exportLiteral(self, outfile, level, name_='Cadence_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(Cadence_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Low':
            ...
            High_ = child_.text
            self.High = High_
        super(Cadence_t, self).buildChildren(child_, nodeName_, True)
# end class Cadence_t
...
class None_t(Target_t):
    ...
    def exportLiteral(self, outfile, level, name_='None_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(None_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        super(None_t, self).buildChildren(child_, nodeName_, True)
        pass
# end class None_t
...
class PredefinedSpeedZone_t(Zone_t):
    ...
    def exportLiteral(self, outfile, level, name_='PredefinedSpeedZone_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(PredefinedSpeedZone_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        ...
        super(PredefinedSpeedZone_t, self).buildChildren(child_, nodeName_, True)
...
class CustomSpeedZone_t(Zone_t):
    ...
    def validate_ViewAs(self, value):
        # validate type ViewAs
        pass
    ...
    def validate_LowInMetersPerSecond(self, value):
        # validate type LowInMetersPerSecond
        pass
    ...
    def validate_HighInMetersPerSecond(self, value):
        # validate type HighInMetersPerSecond
        pass
    ...
    def exportChildren(self, outfile, level, namespace_='tc2:', name_='CustomSpeedZone_t'):
        ...
        if self.LowInMetersPerSecond is not None:
            showIndent(outfile, level)
            outfile.write('<%sLowInMetersPerSecond>%s</%sLowInMetersPerSecond>\n' % (namespace_, self.gds_format_string(quote_xml(self.LowInMetersPerSecond).encode(ExternalEncoding), input_name='LowInMetersPerSecond'), namespace_))
        if self.HighInMetersPerSecond is not None:
            showIndent(outfile, level)
            outfile.write('<%sHighInMetersPerSecond>%s</%sHighInMetersPerSecond>\n' % (namespace_, self.gds_format_string(quote_xml(self.HighInMetersPerSecond).encode(ExternalEncoding), input_name='HighInMetersPerSecond'), namespace_))
    def hasContent_(self):
        if (
    ...
    def exportLiteral(self, outfile, level, name_='CustomSpeedZone_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(CustomSpeedZone_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.LowInMetersPerSecond is not None:
            showIndent(outfile, level)
            outfile.write('LowInMetersPerSecond=%s,\n' % quote_python(self.LowInMetersPerSecond).encode(ExternalEncoding))
        if self.HighInMetersPerSecond is not None:
            showIndent(outfile, level)
            outfile.write('HighInMetersPerSecond=%s,\n' % quote_python(self.HighInMetersPerSecond).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'ViewAs':
            ViewAs_ = child_.text
            self.ViewAs = ViewAs_
            self.validate_ViewAs(self.ViewAs)    # validate type ViewAs
        elif nodeName_ == 'LowInMetersPerSecond':
            LowInMetersPerSecond_ = child_.text
            self.LowInMetersPerSecond = LowInMetersPerSecond_
            self.validate_LowInMetersPerSecond(self.LowInMetersPerSecond)    # validate type LowInMetersPerSecond
        elif nodeName_ == 'HighInMetersPerSecond':
            HighInMetersPerSecond_ = child_.text
            self.HighInMetersPerSecond = HighInMetersPerSecond_
            self.validate_HighInMetersPerSecond(self.HighInMetersPerSecond)    # validate type HighInMetersPerSecond
        super(CustomSpeedZone_t, self).buildChildren(child_, nodeName_, True)
...
class PredefinedHeartRateZone_t(Zone_t):
    ...
    def exportLiteral(self, outfile, level, name_='PredefinedHeartRateZone_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(PredefinedHeartRateZone_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Number':
            ...
            self.Number = Number_
            self.validate_Number(self.Number)    # validate type Number
        super(PredefinedHeartRateZone_t, self).buildChildren(child_, nodeName_, True)
...
class CustomHeartRateZone_t(Zone_t):
    ...
    def exportLiteral(self, outfile, level, name_='CustomHeartRateZone_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(CustomHeartRateZone_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Low': 
            ...
            self.set_High(obj_)
        super(CustomHeartRateZone_t, self).buildChildren(child_, nodeName_, True)
...
class HeartRateInBeatsPerMinute_t(HeartRateValue_t):
    ...
    def exportLiteral(self, outfile, level, name_='HeartRateInBeatsPerMinute_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(HeartRateInBeatsPerMinute_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        ...
        super(HeartRateInBeatsPerMinute_t, self).buildChildren(child_, nodeName_, True)
...
class HeartRateAsPercentOfMax_t(HeartRateValue_t):
    ...
    def exportLiteral(self, outfile, level, name_='HeartRateAsPercentOfMax_t'):
        ...
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        super(HeartRateAsPercentOfMax_t, self).exportLiteralAttributes(outfile, level, name_)
    def exportLiteralChildren(self, outfile, level, name_):
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Value':
            ...
            self.Value = Value_
            self.validate_Value(self.Value)    # validate type Value
        super(HeartRateAsPercentOfMax_t, self).buildChildren(child_, nodeName_, True)
...
class CoursePoint_t(GeneratedsSuper):
    ...
    def validate_PointType(self, value):
        # validate type PointType
        pass
    def get_Notes(self): return self.Notes
    def set_Notes(self, Notes): self.Notes = Notes
    def get_Extensions(self): return self.Extensions
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Name':
            ...
            self.validate_PointType(self.PointType)    # validate type PointType
        elif nodeName_ == 'Notes':
            Notes_ = child_.text
            self.Notes = Notes_
        elif nodeName_ == 'Extensions': 
...
class ActivityTrackpointExtension_t(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, CadenceSensor=None, Speed=None, RunCadence=None, Watts=None, Extensions=None):
        self.CadenceSensor = _cast(None, CadenceSensor)
        self.Speed = Speed
        self.RunCadence = RunCadence
        self.Watts = Watts
        self.Extensions = Extensions
    def factory(*args_, **kwargs_):
        if ActivityTrackpointExtension_t.subclass:
            return ActivityTrackpointExtension_t.subclass(*args_, **kwargs_)
        else:
            return ActivityTrackpointExtension_t(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_Speed(self): return self.Speed
    def set_Speed(self, Speed): self.Speed = Speed
    def get_RunCadence(self): return self.RunCadence
    def set_RunCadence(self, RunCadence): self.RunCadence = RunCadence
    def validate_RunCadence(self, value):
        # validate type RunCadence
        pass
    def get_Watts(self): return self.Watts
    def set_Watts(self, Watts): self.Watts = Watts
    def get_Extensions(self): return self.Extensions
    def set_Extensions(self, Extensions): self.Extensions = Extensions
    def get_CadenceSensor(self): return self.CadenceSensor
    def set_CadenceSensor(self, CadenceSensor): self.CadenceSensor = CadenceSensor
    def validate_CadenceSensorType_t(self, value):
        # Validate type CadenceSensorType_t, a restriction on Token_t.
        pass
    def export(self, outfile, level, namespace_='ax2:', name_='ActivityTrackpointExtension_t', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='ActivityTrackpointExtension_t')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='ax2:', name_='ActivityTrackpointExtension_t'):
        if self.CadenceSensor is not None and 'CadenceSensor' not in already_processed:
            already_processed.append('CadenceSensor')
            outfile.write(' CadenceSensor=%s' % (quote_attrib(self.CadenceSensor), ))
    def exportChildren(self, outfile, level, namespace_='ax2:', name_='ActivityTrackpointExtension_t'):
        if self.Speed is not None:
            showIndent(outfile, level)
            outfile.write('<%sSpeed>%s</%sSpeed>\n' % (namespace_, self.gds_format_string(quote_xml(self.Speed).encode(ExternalEncoding), input_name='Speed'), namespace_))
        if self.RunCadence is not None:
            showIndent(outfile, level)
            outfile.write('<%sRunCadence>%s</%sRunCadence>\n' % (namespace_, self.gds_format_string(quote_xml(self.RunCadence).encode(ExternalEncoding), input_name='RunCadence'), namespace_))
        if self.Watts is not None:
            showIndent(outfile, level)
            outfile.write('<%sWatts>%s</%sWatts>\n' % (namespace_, self.gds_format_string(quote_xml(self.Watts).encode(ExternalEncoding), input_name='Watts'), namespace_))
        if self.Extensions:
            self.Extensions.export(outfile, level, namespace_, name_='Extensions')
    def hasContent_(self):
        if (
            self.Speed is not None or
            self.RunCadence is not None or
            self.Watts is not None or
            self.Extensions is not None
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='ActivityTrackpointExtension_t'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    def exportLiteralAttributes(self, outfile, level, name_):
        if self.CadenceSensor is not None:
            showIndent(outfile, level)
            outfile.write('CadenceSensor = %s,\n' % (self.CadenceSensor,))
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Speed is not None:
            showIndent(outfile, level)
            outfile.write('Speed=%s,\n' % quote_python(self.Speed).encode(ExternalEncoding))
        if self.RunCadence is not None:
            showIndent(outfile, level)
            outfile.write('RunCadence=%s,\n' % quote_python(self.RunCadence).encode(ExternalEncoding))
        if self.Watts is not None:
            showIndent(outfile, level)
            outfile.write('Watts=%s,\n' % quote_python(self.Watts).encode(ExternalEncoding))
        if self.Extensions is not None:
            showIndent(outfile, level)
            outfile.write('Extensions=model_.Extensions_t(\n')
            self.Extensions.exportLiteral(outfile, level, name_='Extensions')
    ...
    def build(self, node):
        ...
        for child in node:
            ...
            self.buildChildren(child, nodeName_)
    def buildAttributes(self, node, attrs, already_processed):
        value = attrs.get('CadenceSensor')
        if value is not None and 'CadenceSensor' not in already_processed:
            already_processed.append('CadenceSensor')
            self.CadenceSensor = value
            self.validate_CadenceSensorType_t(self.CadenceSensor)    # validate type CadenceSensorType_t
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'Speed':
            Speed_ = child_.text
            self.Speed = Speed_
        elif nodeName_ == 'RunCadence':
            RunCadence_ = child_.text
            self.RunCadence = RunCadence_
            self.validate_RunCadence(self.RunCadence)    # validate type RunCadence
        elif nodeName_ == 'Watts':
            Watts_ = child_.text
            self.Watts = Watts_
        elif nodeName_ == 'Extensions': 
            obj_ = Extensions_t.factory()
            obj_.build(child_)
            self.set_Extensions(obj_)
# end class ActivityTrackpointExtension_t


class ActivityLapExtension_t(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, AvgSpeed=None, MaxBikeCadence=None, AvgRunCadence=None, MaxRunCadence=None, Steps=None, AvgWatts=None, MaxWatts=None, Extensions=None):
        self.AvgSpeed = AvgSpeed
        self.MaxBikeCadence = MaxBikeCadence
        self.AvgRunCadence = AvgRunCadence
        self.MaxRunCadence = MaxRunCadence
        self.Steps = Steps
        self.AvgWatts = AvgWatts
        self.MaxWatts = MaxWatts
        self.Extensions = Extensions
    def factory(*args_, **kwargs_):
        if ActivityLapExtension_t.subclass:
            return ActivityLapExtension_t.subclass(*args_, **kwargs_)
        else:
            return ActivityLapExtension_t(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_AvgSpeed(self): return self.AvgSpeed
    def set_AvgSpeed(self, AvgSpeed): self.AvgSpeed = AvgSpeed
    def get_MaxBikeCadence(self): return self.MaxBikeCadence
    def set_MaxBikeCadence(self, MaxBikeCadence): self.MaxBikeCadence = MaxBikeCadence
    def validate_MaxBikeCadence(self, value):
        # validate type MaxBikeCadence
        pass
    def get_AvgRunCadence(self): return self.AvgRunCadence
    def set_AvgRunCadence(self, AvgRunCadence): self.AvgRunCadence = AvgRunCadence
    def validate_AvgRunCadence(self, value):
        # validate type AvgRunCadence
        pass
    def get_MaxRunCadence(self): return self.MaxRunCadence
    def set_MaxRunCadence(self, MaxRunCadence): self.MaxRunCadence = MaxRunCadence
    def validate_MaxRunCadence(self, value):
        # validate type MaxRunCadence
        pass
    def get_Steps(self): return self.Steps
    def set_Steps(self, Steps): self.Steps = Steps
    def get_AvgWatts(self): return self.AvgWatts
    def set_AvgWatts(self, AvgWatts): self.AvgWatts = AvgWatts
    def get_MaxWatts(self): return self.MaxWatts
    def set_MaxWatts(self, MaxWatts): self.MaxWatts = MaxWatts
    def get_Extensions(self): return self.Extensions
    def set_Extensions(self, Extensions): self.Extensions = Extensions
    def export(self, outfile, level, namespace_='ax2:', name_='ActivityLapExtension_t', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        self.exportAttributes(outfile, level, [], namespace_, name_='ActivityLapExtension_t')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='ax2:', name_='ActivityLapExtension_t'):
        pass
    def exportChildren(self, outfile, level, namespace_='ax2:', name_='ActivityLapExtension_t'):
        if self.AvgSpeed is not None:
            showIndent(outfile, level)
            outfile.write('<%sAvgSpeed>%s</%sAvgSpeed>\n' % (namespace_, self.gds_format_string(quote_xml(self.AvgSpeed).encode(ExternalEncoding), input_name='AvgSpeed'), namespace_))
        if self.MaxBikeCadence is not None:
            showIndent(outfile, level)
            outfile.write('<%sMaxBikeCadence>%s</%sMaxBikeCadence>\n' % (namespace_, self.gds_format_string(quote_xml(self.MaxBikeCadence).encode(ExternalEncoding), input_name='MaxBikeCadence'), namespace_))
        if self.AvgRunCadence is not None:
            showIndent(outfile, level)
            outfile.write('<%sAvgRunCadence>%s</%sAvgRunCadence>\n' % (namespace_, self.gds_format_string(quote_xml(self.AvgRunCadence).encode(ExternalEncoding), input_name='AvgRunCadence'), namespace_))
        if self.MaxRunCadence is not None:
            showIndent(outfile, level)
            outfile.write('<%sMaxRunCadence>%s</%sMaxRunCadence>\n' % (namespace_, self.gds_format_string(quote_xml(self.MaxRunCadence).encode(ExternalEncoding), input_name='MaxRunCadence'), namespace_))
        if self.Steps is not None:
            showIndent(outfile, level)
            outfile.write('<%sSteps>%s</%sSteps>\n' % (namespace_, self.gds_format_string(quote_xml(self.Steps).encode(ExternalEncoding), input_name='Steps'), namespace_))
        if self.AvgWatts is not None:
            showIndent(outfile, level)
            outfile.write('<%sAvgWatts>%s</%sAvgWatts>\n' % (namespace_, self.gds_format_string(quote_xml(self.AvgWatts).encode(ExternalEncoding), input_name='AvgWatts'), namespace_))
        if self.MaxWatts is not None:
            showIndent(outfile, level)
            outfile.write('<%sMaxWatts>%s</%sMaxWatts>\n' % (namespace_, self.gds_format_string(quote_xml(self.MaxWatts).encode(ExternalEncoding), input_name='MaxWatts'), namespace_))
        if self.Extensions:
            self.Extensions.export(outfile, level, namespace_, name_='Extensions')
    def hasContent_(self):
        if (
            self.AvgSpeed is not None or
            self.MaxBikeCadence is not None or
            self.AvgRunCadence is not None or
            self.MaxRunCadence is not None or
            self.Steps is not None or
            self.AvgWatts is not None or
            self.MaxWatts is not None or
            self.Extensions is not None
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='ActivityLapExtension_t'):
        level += 1
        self.exportLiteralAttributes(outfile, level, name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.AvgSpeed is not None:
            showIndent(outfile, level)
            outfile.write('AvgSpeed=%s,\n' % quote_python(self.AvgSpeed).encode(ExternalEncoding))
        if self.MaxBikeCadence is not None:
            showIndent(outfile, level)
            outfile.write('MaxBikeCadence=%s,\n' % quote_python(self.MaxBikeCadence).encode(ExternalEncoding))
        if self.AvgRunCadence is not None:
            showIndent(outfile, level)
            outfile.write('AvgRunCadence=%s,\n' % quote_python(self.AvgRunCadence).encode(ExternalEncoding))
        if self.MaxRunCadence is not None:
            showIndent(outfile, level)
            outfile.write('MaxRunCadence=%s,\n' % quote_python(self.MaxRunCadence).encode(ExternalEncoding))
        if self.Steps is not None:
            showIndent(outfile, level)
            outfile.write('Steps=%s,\n' % quote_python(self.Steps).encode(ExternalEncoding))
        if self.AvgWatts is not None:
            showIndent(outfile, level)
            outfile.write('AvgWatts=%s,\n' % quote_python(self.AvgWatts).encode(ExternalEncoding))
        if self.MaxWatts is not None:
            showIndent(outfile, level)
            outfile.write('MaxWatts=%s,\n' % quote_python(self.MaxWatts).encode(ExternalEncoding))
        if self.Extensions is not None:
            showIndent(outfile, level)
            outfile.write('Extensions=model_.Extensions_t(\n')
            self.Extensions.exportLiteral(outfile, level, name_='Extensions')
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'AvgSpeed':
            AvgSpeed_ = child_.text
            self.AvgSpeed = AvgSpeed_
        elif nodeName_ == 'MaxBikeCadence':
            MaxBikeCadence_ = child_.text
            self.MaxBikeCadence = MaxBikeCadence_
            self.validate_MaxBikeCadence(self.MaxBikeCadence)    # validate type MaxBikeCadence
        elif nodeName_ == 'AvgRunCadence':
            AvgRunCadence_ = child_.text
            self.AvgRunCadence = AvgRunCadence_
            self.validate_AvgRunCadence(self.AvgRunCadence)    # validate type AvgRunCadence
        elif nodeName_ == 'MaxRunCadence':
            MaxRunCadence_ = child_.text
            self.MaxRunCadence = MaxRunCadence_
            self.validate_MaxRunCadence(self.MaxRunCadence)    # validate type MaxRunCadence
        elif nodeName_ == 'Steps':
            Steps_ = child_.text
            self.Steps = Steps_
        elif nodeName_ == 'AvgWatts':
            AvgWatts_ = child_.text
            self.AvgWatts = AvgWatts_
        elif nodeName_ == 'MaxWatts':
            MaxWatts_ = child_.text
            self.MaxWatts = MaxWatts_
        elif nodeName_ == 'Extensions': 
            obj_ = Extensions_t.factory()
            obj_.build(child_)
            self.set_Extensions(obj_)
# end class ActivityLapExtension_t
...
class Extensions_t(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, valueOf_=None, LX=None, TPX=None):
        self.valueOf_ = valueOf_
        if LX is None:
            self.LX = []
        else:
    ...
    def buildChildren(self, child_, nodeName_, from_subclass=False):
        if nodeName_ == 'LX': 
            obj_ = ActivityLapExtension_t.factory()
            obj_.build(child_)
            self.LX.append(obj_)
        elif nodeName_ == 'TPX': 
            obj_ = ActivityTrackpointExtension_t.factory()
            obj_.build(child_)
            self.TPX.append(obj_)
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from tcx import *\n\n')
    sys.stdout.write('import tcx as model_\n\n')
